<?php 
    ...
    $URL = 'http://api.geonames.org/findNearbyJSON?lat=' . $_REQUEST['lat'] . '&lng=' . $_REQUEST['lng'] . '&featureClass=S&featureCode=AIRP&maxRows=80&radius=300&username=daniellejane_c';
