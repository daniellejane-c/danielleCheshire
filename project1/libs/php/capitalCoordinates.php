...
if (!isset($_REQUEST['lat']) || !isset($_REQUEST['lng'])) {
    ...
    $output['status']['description'] = "Parameters 'lat' and 'lng' are missing.";
...
$URL = 'https://api.opencagedata.com/geocode/v1/json?q=' . $_REQUEST['lat'] . ',' . $_REQUEST['lng'] .'&key=48a78b864d4b4e85a485b585c3d6fdb0&language=en&pretty=1';
